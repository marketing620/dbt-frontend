    ...
    >
      ...
      <div className="container position-relative z-1 text-center px-4">
        ...
        <div className="mb-4 d-inline-block position-relative">
          ...
          >
            <i
              ...
              style={{ fontSize: "3rem", color: "#13a195" }}
            ></i>
          </div>
          {/* Subtle Sparkle/Tool accents */}
          <i
            className="fa-solid fa-sparkles position-absolute"
            style={{
              color: "#d4af37",
              top: "0",
              right: "-15px",
        ...
        <p
          ...
          style={{ color: "#475569", maxWidth: "650px", lineHeight: "1.8" }}
        >
          Our website is currently undergoing a deep clean to better support
          your practice. We are building a smoother, faster experience to
          streamline your dental revenue cycle. We will be back online shortly!
        </p>

        {/* Contact Assistance Box */}
        <div
          className="card mx-auto rounded-4 p-4 p-lg-5 text-start"
          style={{
            maxWidth: "500px",
            backgroundColor: "#ffffff",
        ...
        >
          <h5 className="fw-bold mb-3" style={{ color: "#1c3b63" }}>
            Need Immediate Assistance?
          </h5>
          <p className="mb-4 text-muted small" style={{ lineHeight: "1.7" }}>
            If you have an urgent inquiry regarding an existing billing audit,
            credentialing, or patient A/R process, please reach out to our team
            directly:
          </p>
