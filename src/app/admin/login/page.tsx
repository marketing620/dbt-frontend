...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Optional: Store the token in localStorage or Cookies if needed for the dashboard
  ...
  return (
    <div className="d-flex min-vh-100" style={{ backgroundColor: "#f8fafc" }}>
        ...
        <div className="w-100 mx-auto" style={{ maxWidth: "420px" }}>
          <div className="mb-5 text-center text-lg-start">
            ...
            <p className="text-secondary">
              Please enter your admin credentials to securely login to your
              dashboard.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="d-flex flex-column gap-4">
            ...
            <div>
              <div className="d-flex justify-content-between align-items-center mb-1">
                <label
                  className="form-label small fw-bold text-dark mb-0"
                  style={{ letterSpacing: "0.5px" }}
                >
                  PASSWORD
                </label>
      ...
      <div
        className="d-none d-lg-flex col-lg-7 flex-column justify-content-center align-items-center position-relative overflow-hidden"
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: "500px",
            background:
              "radial-gradient(circle, rgba(56,189,248,0.1) 0%, rgba(15,23,42,0) 70%)",
            bottom: "-100px",
            left: "-100px",
          }}
        ></div>
        ...
        <div
          className="z-1 text-center text-white px-5"
        ...
        >
          ...
          <p className="lead fw-light text-light" style={{ opacity: 0.8 }}>
            Manage client leads, incoming audit requests, and overall
            application data confidently through your dedicated administrative
            portal.
          </p>
        </div>
        ...
        <div
          className="position-absolute bottom-0 w-75 translate-middle-x start-50 rounded-top-4 shadow-lg border border-bottom-0 border-secondary bg-dark"
        ...
        >
          ...
          <div className="p-4">
            <div
              className="w-50 bg-secondary rounded mb-3"
              style={{ height: "20px", opacity: 0.3 }}
            ></div>
            <div
              className="w-75 bg-secondary rounded mb-2"
              style={{ height: "12px", opacity: 0.2 }}
            ></div>
            <div
              className="w-100 bg-secondary rounded mb-2"
              style={{ height: "12px", opacity: 0.2 }}
            ></div>
          </div>
        </div>
